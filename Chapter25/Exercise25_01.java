...
public class Exercise25_01 {
  ...
  public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public void breadthFirstTraversal() {
      ...
      TreeNode[] currentTier = {root};
      
      int count = 0;
      
      while (count < size) {
    	  
    	  TreeNode[] nextTier = new TreeNode[(currentTier.length * 2)];
    	  
    	  for (int n = 0; n < currentTier.length; n++) {
    		  
    		  if (currentTier[n] != null) {
    			  
    			   nextTier[(2 * n)] = currentTier[n].left;
    			   nextTier[(2 * n) + 1] = currentTier[n].right;
    			   
    			   queue.add(currentTier[n]);
