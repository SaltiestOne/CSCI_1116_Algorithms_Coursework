	...
	//    
	  ...
	  public static class BST<E extends Comparable<E>> extends AbstractTree<E> {
	    ...
	    public void nonRecursiveInorder() {
	    	...
	    	Stack<TreeNode<E>> printStack = new Stack<TreeNode<E>>();
	    	
	    	Stack<TreeNode<E>> finderStack = new Stack<TreeNode<E>>();
	    	
	    	TreeNode<E> current = root;
	    	
	    	while (printStack.size() < size) {
	    		
	    		finderStack.add(current);
	    		
	    		current = current.left;
    			
    			while((current == null) && (!finderStack.isEmpty())) {
    				
    				printStack.add(finderStack.pop());
    				
    				current = printStack.peek().right;
    				
    			}
	    			
	    	}
	    	
	    	printStack.forEach(e -> {
